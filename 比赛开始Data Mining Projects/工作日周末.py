...
for i in range(k_min_2016_weekday,k_2016_weekday):
    ...
    Everyweek_data_weekday_2016_sum_count = Everyweek_data_weekday_2016['2'].sum()/5#核心数据
    for h in range(2):
...
for i in range(k_min_2017_weekday,k_2017_weekday):
    ...
    Everyweek_data_weekday_2017_sum_count = Everyweek_data_weekday_2017['2'].sum()/5#核心数据
    for e in range(2):
...
for i in range(k_min_2018_weekday,k_2018_weekday):
    ...
    Everyweek_data_weekday_2018_sum_count = Everyweek_data_weekday_2018['2'].sum()/5#核心数据
    for l in range(2):
...
Final_Data = pd.DataFrame(np.array([[Everyweek_data_weekday_2015_sum_count_list,
                          weekend_2015_list,
                          Everyweek_data_weekday_2016_sum_count_list,
                          weekend_2016_list,
                          Everyweek_data_weekday_2017_sum_count_list,
                          weekend_2017_list,
                          Everyweek_data_weekday_2018_sum_count_list,
                          weekend_2018_list]],dtype=object),columns=['2015年工作日','2015年周末','2016年工作日',
                                                     '2016年周末',
                                                     '2017年工作日',
                                                     '2017年周末',
                                                     '2018年工作日',
